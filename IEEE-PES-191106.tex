...
% Direct link to bib file
\addbibresource{bibliography.bib} % added bib to repo
...
\input{sections/simExplained}
\input{sections/deadbands}
\input{sections/simValidation}
\input{sections/simResults}
