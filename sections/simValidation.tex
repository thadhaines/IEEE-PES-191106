...
All 21 governors in the miniWECC were modeled with the tgov1 governor, which enabled easier validation.
...
The step test results show that PSLTDSim cannot replace classical transient stability simultion for the study of large, short-duration transient events, however repeated small perturbances are modeled with acceptable deviation from transient simulation methods.